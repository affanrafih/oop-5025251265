...
public class AkunAnggota
{
    ...
    public AkunAnggota(string nomorAnggota)
    {
        ...
        if(string.IsNullOrWhiteSpace(nomorAnggota)) throw new ArgumentException("Nomor anggota tidak boleh null, kosong atau spasi");
    ...
    public void TambahDenda(int rupiah)
    {
        ...
        //   tambahkan ke Denda.
        if(rupiah <= 0) throw new ArgumentOutOfRangeException("nilai harus lebih dari 0 ");
    ...
    public int BayarDenda(int rupiah)
    {
        ...
        if(rupiah <= 0) throw new ArgumentOutOfRangeException("nilai harus lebih dari 0 ");
        if(rupiah > Denda) throw new InvalidOperationException("jumlah pembayaran lebih dari denda");
